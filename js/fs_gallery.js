...
jQuery.fn.fs_gallery = function (fs_options) {
    ...
    jQuery('.fs_gallery_slider').append('<div class="fs_controls slider_btns ' + show_class + '"><a href="javascript:void(0)" class="fs_share_toggler"></a><a href="javascript:void(0)" class="fs_slider_prev ltl_prev"/><a href="javascript:void(0)" id="fs_play-pause" class="'+playpause+'"></a><a href="javascript:void(0)" class="fs_slider_next ltl_next"/><a href="javascript:void(0)" class="close_controls ' + controls_class + '"></a></div><div class="fs_thmb_viewport ' + show_class + '"><div class="fs_thmb_wrapper"><ul class="fs_thmb_list" style="width:' + fs_options.slides.length * 128 + 'px"></ul></div></div>');
